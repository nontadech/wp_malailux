	...
	class em_slideshowcarousel extends AQ_Block {
		public function __construct() {
			...
			$mtheme_shortcodes['slideshowcarousel'] = array(
				...
				'shortcode' => '[slideshowcarousel autoplay="{{autoplay}}" displaytitle="{{displaytitle}}" thumbnails="{{thumbnails}}" pb_image_ids="{{pb_image_ids}}"]',
