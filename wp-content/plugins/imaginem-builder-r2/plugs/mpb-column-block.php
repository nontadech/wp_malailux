			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					  ...
					  <div type="button" class="tb-close-icon" data-dismiss="modal" aria-hidden="true"></div>
						  ...
						  <label for="blockID"><?php _e('Block ID','mthemelocal'); ?></label><input class="blockID" type="text" name="<?php echo $block_saving_id ?>[blockID]" value="<?php echo sanitize_title_with_dashes($blockID) ?>" id="blockID"/>
					  </div>
