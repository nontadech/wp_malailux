...
/*-------------------------------------------------------------------------*/	
	...
	wp_enqueue_style( 'Lato', 'http://fonts.googleapis.com/css?family=Lato:400,100,100italic,300,300italic,400italic,700,700italic,900,900italic' , array( 'MainStyle' ), null, 'screen' );
	wp_enqueue_style( 'Crimson', 'http://fonts.googleapis.com/css?family=Crimson+Text:400,400italic,600,600italic,700,700italic' , array( 'MainStyle' ), null, 'screen' );
	wp_enqueue_style( 'PT_Mono', 'http://fonts.googleapis.com/css?family=PT+Mono' , array( 'MainStyle' ), null, 'screen' );
...
function mtheme_body_class( $classes ) {
	...
	if ( mtheme_is_fullscreen_post() ) {
		...
		if (isSet($custom[MTHEME . "_fullscreen_infobox"][0])){
			...
			if ($fullscreen_infobox == 'events' || $fullscreen_infobox == 'portfolio' || $fullscreen_infobox == 'blog' || $fullscreen_infobox == 'worktype') {
