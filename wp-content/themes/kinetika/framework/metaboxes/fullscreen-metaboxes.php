...
$mtheme_fullscreen_box = array(
	...
	'fields' => array(
		...
		array(
			'name' => __('Cover Text Style','mthemelocal'),
			'id' => MTHEME . '_cover_style',
			'type' => 'image',
			'std' => 'plain',
			'class' => 'page_type-coverphoto page_type-trigger',
		...
		array(
			...
			'type' => 'fontselector',
			'class' => 'page_type-slideshow page_type-kenburns page_type-coverphoto page_type-trigger',
		...
		array(
			...
			'type' => 'text',
			'class' => 'mtextfield-small page_type-slideshow page_type-kenburns page_type-coverphoto page_type-trigger',
		...
		array(
			'name' => __('For Cover Photo,Kenburns & Static Slideshow Text','mthemelocal'),
		...
		array(
			...
			'id' => MTHEME . '_page_section_id',
			'type' => 'break',
			'class'=> 'page_type-slideshow page_type-video page_type-kenburns page_type-coverphoto page_type-trigger',
		...
		array(
			...
			'class'=> 'slideshowaudio page_type-slideshow page_type-kenburns page_type-coverphoto page_type-trigger',
			'type' => 'text',
