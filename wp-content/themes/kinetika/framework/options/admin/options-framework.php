...
function mtheme_safe_save_options() {
	$countarray=0;
...
add_action('wp_ajax_mtheme_save_options','mtheme_safe_save_options');
...
function optionsframework_init() {
	...
	require_once( OPTIONS_FRAMEWORK_ROOT . 'google-fonts.php');
	...
	if ( empty($_POST) || !wp_verify_nonce($_POST['mtheme_options_nonce'], basename(__FILE__))) {
		...
		if (isset( $_POST['import'] )) {
			...
			if ( $importpack<>"" && is_serialized($importpack) ) {
				...
				add_settings_error( 'options-framework', 'restore_defaults', __( 'Saved Settings!', 'mthemelocal' ), 'updated fade' );
			}
		}
...
function optionsframework_page() {
	...
	<div id='saveMessage' class='successModal'>Settings Saved!</div>
	<div id='errorMessage' class='errorModal'>Error Saving!</div>
	<form method="post" id="mtheme-admin-options-form"> 
		<?php /* Top buttons */ ?>
		<div id="optionsframework-submit">
			<div class="optionsframework-submit-inner">
				<span>
				<div class="options-title"><span class="mtheme-admin-icon dashicons dashicons-admin-generic"></span><?php echo __('Theme Options','mthemelocal'); ?></div>
	    ...
	    <div id="optionsframework" class="postbox">
	        ...
	        <div id="optionsframework-reset">
				...
				<div id="submit-options-ajax" class="button-primary topbutton-right">Save all Options</div>
