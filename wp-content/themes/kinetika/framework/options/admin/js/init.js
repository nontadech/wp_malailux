jQuery(document).ready( function($) {
  ...
  $('.options_wrap').fadeIn();
	...
	// Ajax Save Settings!
   $('#submit-options-ajax').live("click", function(){
   	  var formdata = $('#mtheme-admin-options-form').serialize();
   	  //console.log(formdata);
      $.ajax({
        type: "post",
        url: ajaxurl,
        data: formdata + '&action=mtheme_save_options',
		beforeSend : function(){
		},
      ...
      setTimeout("jQuery('#saveMessage,#errorMessage').slideUp();", 4000);
