...
$options[] = array( "name"			=> __("General", "mthemelocal" ),
	...
	$options[] = array( "name" => __("Right Click Message", "mthemelocal" ),
						"desc" => __("This text appears in the popup when right click is disabled. Escapes single quotes, htmlspecialchar < > & codes. Characters which aren't allowed through javascript user entered strings", "mthemelocal" ),
