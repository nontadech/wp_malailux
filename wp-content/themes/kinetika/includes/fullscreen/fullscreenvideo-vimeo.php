...
<<?php echo esc_attr($embed_type); ?> frameborder="0" allowfullscreen="" webkitallowfullscreen="" src="http://player.vimeo.com/video/<?php echo $vimeoID; ?>?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=1&amp;loop=0"></<?php echo esc_attr($embed_type); ?>>
</div>
<?php
