...
if (of_get_option('default_googlewebfonts')) {
	...
	$dynamic_css .= mtheme_apply_font ( "menu_font" , ".homemenu .sf-menu a, .homemenu .sf-menu,.homemenu .sf-menu ul li a" );
...
if ($lightbox_bgcolor) {
$dynamic_css .= '.mfp-bg { background-color:'.$lightbox_bgcolor.'; }';
}
